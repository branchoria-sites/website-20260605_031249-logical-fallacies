...
child_basenames:
- logical_fallacies_998914_false_dilemmas_827e99_index
...
show_ads: true
description: False dilemmas make complex choices look like only two extremes when practical alternatives may exist.
hero_summary: False dilemmas make complex choices look like only two extremes when practical alternatives may exist.
layout: default
...
page_heading_title: What Choices Are Being Hidden?
source_count: 122
infographic_count: 3
planned_sections:
- Either or framing
...
next_link:
  ...
  heading_title: When the Structure Makes Reasoning Fail
header:
  og_image: /assets/images/logical_fallacies_998914_false_dilemmas_827e99-overview-social.jpg
  preview_image: /assets/images/logical_fallacies_998914_false_dilemmas_827e99-overview.webp
image: /assets/images/logical_fallacies_998914_false_dilemmas_827e99-overview-social.jpg
---
...
1. **State the offered choice clearly.** What are the two options being presented?
2. **Ask what conclusion the choice is meant to force.** Is one option being made to look unavoidable?
3. **List omitted alternatives.** Include hybrids, staged actions, exceptions, partial agreement, abstention, delay, reversal and reframing.
4. **Check whether the omitted options are relevant.** A far-fetched possibility does not defeat a dilemma; a practical alternative does.
5. **Ask who benefits from the narrowed frame.** The person defining the options often shapes the outcome.
6. **Rebuild the argument with the added options.** If the conclusion no longer follows, the original dilemma was doing too much work.
