...
- logical_fallacies_998914_post_hoc_reasoning_729d96_lucky_shirts_superst_b4e0f7
...
show_ads: true
description: Extreme results often move closer to normal on their own, making weak interventions look more effective than they are.
hero_summary: Extreme results often move closer to normal on their own, making weak interventions look more effective than they are.
layout: default
...
page_heading_title: When Improvement Was Already Likely
source_count: 55
infographic_count: 3
planned_sections:
- Why extreme results tend to soften over time
- How regression creates false success stories
- Examples from health, business, and performance
...
- basename: logical_fallacies_998914_post_hoc_reasoning_729d96_lucky_shirts_superst_b4e0f7
  title: Lucky Rituals | False Cause
  permalink: /lucky-rituals/
  short_title: Lucky Rituals
...
next_link:
  ...
  heading_title: When After a Vaccine Is Not Proof
header:
  og_image: /assets/images/logical_fallacies_998914_post_hoc_reasoning_729d96_regression_to_mean_p_eca456-Illustration-1-social.jpg
  preview_image: /assets/images/logical_fallacies_998914_post_hoc_reasoning_729d96_regression_to_mean_p_eca456-Illustration-1.webp
image: /assets/images/logical_fallacies_998914_post_hoc_reasoning_729d96_regression_to_mean_p_eca456-Illustration-1-social.jpg
---
...
Regression to the mean occurs when measurements are influenced by both stable factors and temporary fluctuations. An extreme score often reflects a mixture of genuine underlying conditions and short-term influences such as luck, timing, measurement error, fatigue, stress, or random variation. Because those temporary influences are unlikely to repeat in exactly the same way, later measurements tend to move closer to the long-run average. OUP Academic <span class="citation-chip-wrap"><a class="citation-chip" href="https://statisticsbyjim.com/basics/regression-to-the-mean/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: statisticsbyjim.com">[Statistics By Jim]</a><span class="citation-popover" role="note"><span class="citation-popover-source">statisticsbyjim.com</span><span class="citation-popover-title">regression to the mean</span><span class="citation-popover-snippet">Statistics By JimRegression to the Mean: Definition &amp; ExamplesMar 28, 2024 — Regression to the mean is the statistical tendency for an un...</span></span></span>

A classic example involves [test scores]({{ 'test-scores/' | relative_url }}). A student who performs extraordinarily well on one test may have benefited from unusually favourable circumstances. Another student who performs extraordinarily badly may have suffered from temporary disadvantages. On a later test, both students are likely to move somewhat closer to their typical level of performance. This does not require any intervention. It is a consequence of how variation works when outcomes are not perfectly consistent. <span class="citation-link-wrap"><a class="citation-inline-link" href="https://en.wikipedia.org/wiki/Regression_toward_the_mean" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">Regression toward the mean</span><span class="citation-popover-snippet">Regression toward the mean</span></span></span>

The key point is that regression to the mean is statistical rather than causal. It does not mean that some force is pushing outcomes back to average. Instead, extreme observations often contain a larger component of chance than ordinary observations, making repetition of the same extreme result unlikely. <span class="citation-chip-wrap"><a class="citation-chip" href="https://statisticsbyjim.com/basics/regression-to-the-mean/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: statisticsbyjim.com">[Statistics By Jim]</a><span class="citation-popover" role="note"><span class="citation-popover-source">statisticsbyjim.com</span><span class="citation-popover-title">regression to the mean</span><span class="citation-popover-snippet">Statistics By JimRegression to the Mean: Definition &amp; ExamplesMar 28, 2024 — Regression to the mean is the statistical tendency for an un...</span></span></span> <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.abc.net.au/science/articles/2015/05/12/4217146.htm" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: abc.net.au">[ABC News]</a><span class="citation-popover" role="note"><span class="citation-popover-source">abc.net.au</span><span class="citation-popover-title">ABC News What does regression to the mean, mean?</span><span class="citation-popover-snippet">What does regression to the mean, mean?May 12, 2015 — Regression is caused by performances fluctuating about ability, so that performance...</span><span class="citation-popover-meta">Published: May 12, 2015</span></span></span>

## How Regression Creates False Success Stories

The most misleading situations arise when people act only after a result becomes extreme.

Imagine a manager intervenes after a sales team records its worst month in years. The next month's figures improve. The manager concludes that the intervention worked. Yet if the poor month was partly an outlier, some improvement may have been expected even if the manager had done nothing.
...
1. An unusually bad outcome occurs.
2. Someone introduces a remedy.
3. Results improve.
4. The remedy receives credit.
...
Businesses frequently reward or punish employees after unusually good or bad performance. This creates fertile ground for post hoc stories.

Suppose a sales representative has a terrible quarter. Management introduces a new coaching programme. The next quarter is better. The programme is celebrated as a success.
...
Sport offers vivid examples because extraordinary performances attract attention.

The famous “Sports Illustrated cover jinx” claims that athletes featured on the magazine's cover often decline afterwards. A more mundane explanation is that athletes are selected for the cover precisely because they have just achieved an exceptional performance. Since exceptional performances are difficult to sustain, subsequent results are likely to be less extraordinary. Regression to the mean predicts exactly this pattern. <span class="citation-link-wrap"><a class="citation-inline-link" href="https://en.wikipedia.org/wiki/Regression_toward_the_mean" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">Regression toward the mean</span><span class="citation-popover-snippet">Regression toward the mean</span></span></span> <span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.psychologytoday.com/gb/blog/what-the-luck/201610/the-sports-illustrated-cover-jinx" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: psychologytoday.com">[Psychology Today]</a><span class="citation-popover" role="note"><span class="citation-popover-source">psychologytoday.com</span><span class="citation-popover-title">the sports illustrated cover jinx</span><span class="citation-popover-snippet">Psychology TodayThe Sports Illustrated Cover Jinx12 Oct 2016 — The Sports Illustrated Jinx and the Madden Curse are extreme examples of r...</span></span></span>

The same logic appears in stories about rookie sensations, championship teams, and unexpectedly profitable business quarters. Exceptional outcomes often contain an element of luck or temporary advantage. When those temporary factors fade, performance appears to decline, creating the illusion that some new event caused the change. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.theguardian.com/sport/2002/jan/20/ussport.lawrencedonegan" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: theguardian.com">[The Guardian]</a><span class="citation-popover" role="note"><span class="citation-popover-source">theguardian.com</span><span class="citation-popover-snippet">magazine&#x27;s long-held belief that the &#x27;jinx&#x27; could be explained away by the theory of &#x27;regression to the mean&#x27;. In plain language this mea...</span></span></span>
...
* **The intervention followed an unusually extreme result.**
* **The evidence relies mainly on before-and-after comparisons.**
* **The outcome naturally fluctuates over time.**
* **No comparable control group is available.**
* **The improvement is measured immediately after a peak or trough.**
* **The explanation assumes that any subsequent change must have been caused by the intervention.**
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to When Improvement Was Already Likely. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Includes discussion of regression toward the mean.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Shows how random variation creates false success stories.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains statistical effects behind apparent improvement.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Discusses regression to the mean as a common reasoning error.</p>
        <div class="fr-book-actions">
...
<section class="further-reading-section" data-page-toc-exclude data-ebay-market-switch aria-labelledby="merchant-block-title">
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Browse similar items on eBay for Anvil Rotting Corpse Fallacy Houston 2012 Art Poster Print Signed Flynn Prejean"><img src="{{ '/assets/images/marketplace-covers/52e153c2980e4d629616.jpg' | relative_url }}" alt="Listing image for Anvil Rotting Corpse Fallacy Houston 2012 Art Poster Print Signed Flynn Prejean" loading="lazy" decoding="async" fetchpriority="low"></a>
      <div class="fr-book-info">
        <p class="fr-book-kicker">Example eBay listing</p>
        <h4 class="fr-book-title">
          <a href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">Anvil Rotting Corpse Fallacy Houston 2012 Art Poster Print Signed Flynn Prejean</a>
        </h4>
        <a class="fr-book-fit" href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Search eBay for fallacy poster">Search <span data-ebay-domain-label>eBay.com</span>: fallacy poster</a>
        <div class="fr-book-actions">
          <a href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        <p class="fr-book-kicker">Example eBay listing</p>
        <h4 class="fr-book-title">
          <a href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">Base rate fallacy black Framed Art Framed Wall Art Poster Canvas Print Picture</a>
        </h4>
        <a class="fr-book-fit" href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Search eBay for fallacy poster">Search <span data-ebay-domain-label>eBay.com</span>: fallacy poster</a>
        <div class="fr-book-actions">
          <a href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        <p class="fr-book-kicker">Example eBay listing</p>
        <h4 class="fr-book-title">
          <a href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">Logical Fallacies Poster ,Critical Thinking Wall Art , Philosophy Infographic</a>
        </h4>
        <a class="fr-book-fit" href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Search eBay for fallacy poster">Search <span data-ebay-domain-label>eBay.com</span>: fallacy poster</a>
        <div class="fr-book-actions">
          <a href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        <p class="fr-book-kicker">Example eBay listing</p>
        <h4 class="fr-book-title">
          <a href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">Don&#x27;t Make A Logical Fallacy Poster Poster of Common Logical Canvas</a>
        </h4>
        <a class="fr-book-fit" href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Search eBay for fallacy poster">Search <span data-ebay-domain-label>eBay.com</span>: fallacy poster</a>
        <div class="fr-book-actions">
          <a href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
      ...
      <div class="fr-section-footer">
        <a class="fr-browse-more" href="https://www.ebay.com/sch/i.html?_nkw=fallacy+poster&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=regression-when-improvement-was-already-likely-logical-fallacies-fallacy-poster&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">
