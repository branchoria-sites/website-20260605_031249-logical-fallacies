...
show_ads: true
description: A counterargument becomes a straw man when it attacks a weaker version of an objection instead of the real one.
hero_summary: A counterargument becomes a straw man when it attacks a weaker version of an objection instead of the real one.
layout: default
permalink: /straw-men/
...
page_heading_title: Are You Answering the Real Objection?
source_count: 38
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: How One Example Becomes Too Much
header:
  og_image: /assets/images/logical_fallacies_998914_essay_fallacies_4a857b_straw_man_counterarg_583a14-Illustration-1-social.jpg
  preview_image: /assets/images/logical_fallacies_998914_essay_fallacies_4a857b_straw_man_counterarg_583a14-Illustration-1.webp
image: /assets/images/logical_fallacies_998914_essay_fallacies_4a857b_straw_man_counterarg_583a14-Illustration-1-social.jpg
---
...
> Some people think [social media]({{ 'social-media/' | relative_url }}) should be completely banned because it causes anxiety. However, banning social media is unrealistic, so their argument fails.
...
1. **Would a supporter of the opposing view recognise this description as fair?**
2. **Am I responding to the strongest reasonable objection rather than the weakest one?**
3. **Have I challenged the evidence or reasoning behind the objection instead of attacking an exaggerated version of it?**
