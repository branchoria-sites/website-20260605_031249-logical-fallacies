...
show_ads: true
description: Familiar options can feel less risky even when nobody has compared them fairly with available alternatives.
hero_summary: Familiar options can feel less risky even when nobody has compared them fairly with available alternatives.
layout: default
...
page_heading_title: Why Familiar Choices Feel Safer
source_count: 45
infographic_count: 3
planned_sections:
...
image: /assets/images/logical_fallacies_998914_appeal_to_tradition_3c0a72_status_quo_bias_fami_91854c-Illustration-1-social.jpg
---
...
Because status quo bias gives existing practices an automatic advantage, [fair comparison]({{ 'fair-comparison/' | relative_url }}) requires deliberate effort.
