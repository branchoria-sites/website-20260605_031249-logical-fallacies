...
show_ads: true
description: Systematic checks can reveal whether a problem lies in a premise, inference, assumption, or objection.
hero_summary: Systematic checks can reveal whether a problem lies in a premise, inference, assumption, or objection.
layout: default
...
page_heading_title: Which Part of the Argument Actually Fails?
source_count: 42
infographic_count: 3
planned_sections:
- Checking premises
...
prev_link:
  ...
  heading_title: Do the Objections Undermine the Policy or the Reasoning?
header:
  og_image: /assets/images/logical_fallacies_998914_argument_mapping_8e4963_weak_link_checks_93e61d-Illustration-1-social.jpg
  preview_image: /assets/images/logical_fallacies_998914_argument_mapping_8e4963_weak_link_checks_93e61d-Illustration-1.webp
image: /assets/images/logical_fallacies_998914_argument_mapping_8e4963_weak_link_checks_93e61d-Illustration-1-social.jpg
---
...
### Hidden Premises as Potential Weak Links
...
## A Practical Weak-Link Sequence

When analysing an [argument map]({{ 'argument-map/' | relative_url }}), a systematic order prevents confusion:

1. Identify the conclusion being tested.
2. Examine each premise for truth, clarity and [relevance]({{ 'relevance/' | relative_url }}).

<div class="content-enhancement content-enhancement--step-flow" markdown="1">

3. Look for hidden assumptions or warrants.
4. Test whether the inference would remain convincing if all premises were true.
5. Examine objections separately from supporting reasons.
6. Check whether qualifiers accurately reflect the available evidence.
7. Locate the single point whose failure most damages the argument.
