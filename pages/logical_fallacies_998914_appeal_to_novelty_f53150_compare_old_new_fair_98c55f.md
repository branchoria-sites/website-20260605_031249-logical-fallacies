...
show_ads: true
description: The fair test is not whether an option is old or new, but what each one improves, preserves, risks, and costs.
hero_summary: The fair test is not whether an option is old or new, but what each one improves, preserves, risks, and costs.
layout: default
...
page_heading_title: How to Compare Old and New Fairly
source_count: 33
infographic_count: 3
planned_sections:
...
image: /assets/images/logical_fallacies_998914_appeal_to_novelty_f53150_compare_old_new_fair_98c55f-Illustration-1-social.jpg
---
...
1. What specific problem does the current system have?
2. What measurable improvement is expected?
3. What trade-offs accompany the improvement?
4. What are the transition costs and risks?
5. What evidence would prove the replacement unsuccessful?
