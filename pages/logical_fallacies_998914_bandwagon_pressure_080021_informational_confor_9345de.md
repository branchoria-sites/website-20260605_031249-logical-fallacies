...
show_ads: true
description: Following the crowd can be reasonable when others have real expertise, but risky when people are only copying one another.
hero_summary: Following the crowd can be reasonable when others have real expertise, but risky when people are only copying one another.
layout: default
...
page_heading_title: When Should You Trust the Crowd?
source_count: 39
infographic_count: 3
planned_sections:
...
image: /assets/images/logical_fallacies_998914_bandwagon_pressure_080021_informational_confor_9345de-Illustration-1-social.jpg
---
