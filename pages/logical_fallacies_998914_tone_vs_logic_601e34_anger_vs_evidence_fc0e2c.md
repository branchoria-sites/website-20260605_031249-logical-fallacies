...
show_ads: true
description: Emotional language is not a fallacy unless it replaces evidence, pressures the audience, or distracts from the claim being tested.
hero_summary: Emotional language is not a fallacy unless it replaces evidence, pressures the audience, or distracts from the claim being tested.
layout: default
permalink: /anger/
...
page_heading_title: Can an angry argument still be logical?
source_count: 56
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: When is a personal criticism relevant?
header:
  og_image: /assets/images/logical_fallacies_998914_tone_vs_logic_601e34_anger_vs_evidence_fc0e2c-Illustration-1-social.jpg
  preview_image: /assets/images/logical_fallacies_998914_tone_vs_logic_601e34_anger_vs_evidence_fc0e2c-Illustration-1.webp
image: /assets/images/logical_fallacies_998914_tone_vs_logic_601e34_anger_vs_evidence_fc0e2c-Illustration-1-social.jpg
---
...
* **Anger as guilt pressure:** “If you are not angry about this, you obviously do not care.”
* **Anger as distraction:** “Look how shocking this is!” without explaining why the conclusion follows.
* **Anger as a shortcut to certainty:** “This makes me furious, therefore it must be wrong.”
...
One practical way to evaluate an angry argument is to mentally remove the emotional language.

If the remaining reasons still support the conclusion, the anger was not the argument's foundation. If the argument collapses once the emotional force disappears, then emotion was probably doing the work that evidence should have been doing.

Compare these two examples:

**Example A**

> “I am angry because the council withheld pollution measurements. Residents need access to the data to evaluate health risks.”

Remove the anger and the argument still exists:

> “Residents need access to the data to evaluate health risks.”

The reason remains relevant.

**Example B**

> “This decision is outrageous. Everyone should oppose it.”

Remove the emotional language and little remains:
...
### Anger that remains relevant

Suppose a whistle-blower describes dangerous conditions in a workplace:
...
A further complication arises when anger becomes personal:
