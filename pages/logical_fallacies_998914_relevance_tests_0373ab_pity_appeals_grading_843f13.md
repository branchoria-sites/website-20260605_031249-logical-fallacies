...
show_ads: true
description: Hardship may deserve compassion, but it does not automatically prove that a grade has been earned.
hero_summary: Hardship may deserve compassion, but it does not automatically prove that a grade has been earned.
layout: default
...
page_heading_title: When Sympathy Does Not Prove the Claim
source_count: 33
infographic_count: 3
planned_sections:
- Why pity feels relevant
- Grading criteria versus compassionate responses
...
next_link:
  ...
  heading_title: Does Popular Belief Make a Claim True?
header:
  og_image: /assets/images/logical_fallacies_998914_relevance_tests_0373ab_pity_appeals_grading_843f13-Illustration-1-social.jpg
  preview_image: /assets/images/logical_fallacies_998914_relevance_tests_0373ab_pity_appeals_grading_843f13-Illustration-1.webp
image: /assets/images/logical_fallacies_998914_relevance_tests_0373ab_pity_appeals_grading_843f13-Illustration-1-social.jpg
---
...
Question being decidedRelevant evidenceShould the grade be changed?Quality of work, accuracy of marking, rubric application, assessment standardsShould an extension be granted?Documented hardship, illness, emergencies, exceptional circumstancesShould accommodations be provided?Accessibility needs, medical documentation, institutional policyShould disciplinary penalties be reconsidered?Circumstances, intent, procedural fairness, applicable rules
...
* Determining whether a student qualifies for emergency assistance.
* Evaluating requests for deadline flexibility.
* Considering withdrawal, deferment, or special-circumstances procedures.
* Assessing support services that exist specifically to address hardship.

</div>

In these cases, the hardship is not a distraction from the standard; it is part of the standard.
...
A useful way to analyse grade-related pity appeals is to separate two questions that often become tangled together.

### Question 1: Does the person deserve understanding?

Many times the answer is yes. Hardship can be real, severe, and deserving of empathy. Acknowledging this does not commit anyone to a particular academic judgement.
...
* Was the work marked incorrectly?
* Were grading criteria applied consistently?
* Was a factual error made in assessment?
* Does the work satisfy the requirements for the requested grade?
* Do institutional rules provide a formal remedy?

</div>

If the answer depends on these questions, then sympathy alone cannot establish the conclusion.
...
1. Identify the conclusion: "My grade should be raised."
2. Identify the reason: "I experienced serious difficulties."
3. Ask whether the reason directly shows that the assessed work met the grading criteria.
4. If not, determine whether the hardship instead supports a different conclusion, such as eligibility for accommodations or an extension.
