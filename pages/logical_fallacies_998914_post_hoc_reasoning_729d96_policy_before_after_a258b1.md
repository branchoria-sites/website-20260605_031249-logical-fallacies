...
show_ads: true
description: A policy followed by better outcomes may deserve attention, but background trends and other changes can explain the same result.
hero_summary: A policy followed by better outcomes may deserve attention, but background trends and other changes can explain the same result.
layout: default
...
page_heading_title: Did the Policy Work, or Just Arrive First?
source_count: 60
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: When Improvement Was Already Likely
header:
  og_image: /assets/images/logical_fallacies_998914_post_hoc_reasoning_729d96_policy_before_after_a258b1-Illustration-1-social.jpg
  preview_image: /assets/images/logical_fallacies_998914_post_hoc_reasoning_729d96_policy_before_after_a258b1-Illustration-1.webp
image: /assets/images/logical_fallacies_998914_post_hoc_reasoning_729d96_policy_before_after_a258b1-Illustration-1-social.jpg
---
...
1. A policy was introduced.
2. An outcome improved or worsened afterwards.
3. Therefore, the policy caused the change.
...
Governments often introduce policies in response to crises: spikes in crime, unusually high unemployment, poor [test scores]({{ 'test-scores/' | relative_url }}), or disease outbreaks. Extreme outcomes frequently move closer to normal levels over time even without intervention. If a policy is introduced near the peak of a problem, some improvement may occur naturally. Observers may then mistakenly attribute this expected rebound to the policy itself.
...
* [Mechanisms]({{ 'mechanisms/' | relative_url }}) explaining how the policy should work.
...
1. **Was the trend already moving in that direction before the policy?**
2. **What else changed at the same time?**
3. **How did comparable places or groups perform without the policy?**
