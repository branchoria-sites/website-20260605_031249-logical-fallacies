...
show_ads: true
description: A rule does not stop being a rule just because it includes defined exceptions for emergencies or equal-access needs.
hero_summary: A rule does not stop being a rule just because it includes defined exceptions for emergencies or equal-access needs.
layout: default
permalink: /rule-limits/
sidebar_expanded_urls:
- /logical-fallacies/
- /deadlines/
nav_short_title: Rule Limits
title: Is a Flexible Deadline Still a Deadline?
title_full: Is a Flexible Deadline Still a Deadline? | Deadlines
display_title_short: Rule Limits
display_title: Rule Limits
heading_title: Is a Flexible Deadline Still a Deadline?
page_heading_title: Is a Flexible Deadline Still a Deadline?
source_count: 31
infographic_count: 3
planned_sections:
- The false binary between rigidity and collapse
...
next_link:
  ...
  heading_title: Can Self Certified Extensions Stay Fair?
header:
  og_image: /assets/images/logical_fallacies_998914_deadline_slippery_sl_ce90e1_deadlines_with_excep_f3d9e3-Illustration-1-social.jpg
  preview_image: /assets/images/logical_fallacies_998914_deadline_slippery_sl_ce90e1_deadlines_with_excep_f3d9e3-Illustration-1.webp
image: /assets/images/logical_fallacies_998914_deadline_slippery_sl_ce90e1_deadlines_with_excep_f3d9e3-Illustration-1-social.jpg
---
...
The strongest answer to slippery-slope fears is not that exceptions are harmless in every form. It is that institutions can create [boundaries]({{ 'boundaries/' | relative_url }}) that distinguish justified exceptions from ordinary requests.

Several [mechanisms]({{ 'mechanisms/' | relative_url }}) commonly appear in successful deadline systems:
...
Within debates about [logical fallacies]({{ 'logical-fallacies/' | relative_url }}), the most important lesson is that a deadline system should be evaluated by its actual mechanisms, not by imagined extremes.
