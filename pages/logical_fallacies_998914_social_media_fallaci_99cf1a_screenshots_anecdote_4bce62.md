...
show_ads: true
description: A real screenshot, quote or personal story can still support a bad conclusion when context and scale are missing.
hero_summary: A real screenshot, quote or personal story can still support a bad conclusion when context and scale are missing.
layout: default
...
page_heading_title: Why Screenshots Are Not Always Evidence
source_count: 35
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: When Personal Attacks Pretend To Prove A Point
header:
  og_image: /assets/images/logical_fallacies_998914_social_media_fallaci_99cf1a_screenshots_anecdote_4bce62-Illustration-1-social.jpg
  preview_image: /assets/images/logical_fallacies_998914_social_media_fallaci_99cf1a_screenshots_anecdote_4bce62-Illustration-1.webp
image: /assets/images/logical_fallacies_998914_social_media_fallaci_99cf1a_screenshots_anecdote_4bce62-Illustration-1-social.jpg
---
...
The anecdote problem follows a similar pattern. An anecdote is a personal story, observation, or individual [experience]({{ 'experience/' | relative_url }}). Such accounts can be valuable because they describe real events and human consequences. The error appears when a small number of experiences is treated as proof of a general rule.
