...
show_ads: true
description: An ad hominem response should avoid the personality fight and bring attention back to the evidence at stake.
hero_summary: An ad hominem response should avoid the personality fight and bring attention back to the evidence at stake.
layout: default
...
page_heading_title: Do Not Take the Personal Bait
source_count: 33
infographic_count: 3
planned_sections:
- Separate character from evidence
- Use one sentence deflection
...
next_link:
  ...
  heading_title: The Fairer Way to Win Arguments
header:
  og_image: /assets/images/logical_fallacies_998914_debate_fallacies_6ade0b_ad_hominem_evidence_cb9d6d-Illustration-1-social.jpg
  preview_image: /assets/images/logical_fallacies_998914_debate_fallacies_6ade0b_ad_hominem_evidence_cb9d6d-Illustration-1.webp
image: /assets/images/logical_fallacies_998914_debate_fallacies_6ade0b_ad_hominem_evidence_cb9d6d-Illustration-1-social.jpg
---
...
The first task is to identify exactly what has been attacked.
...
* “Your statistics are wrong because you are biased.”
* “We should ignore that proposal because its supporter is a hypocrite.”
* “Her conclusion must be false because she belongs to that political group.”
...
* “That addresses me, not the evidence.”
* “Whether I am right or wrong personally, the data still need to be examined.”
* “The question is not my character; the question is whether the claim is supported.”
* “Even if that criticism were true, it would not tell us whether the argument succeeds.”

</div>

The purpose of these responses is not to win a side dispute. The purpose is to deny the attack control over the agenda.

A useful pattern is:

**Name the diversion → identify the real question → return to evidence.**

For example:

> “That is a criticism of my motives. The issue is whether the reported figures are accurate. Let's look at the figures.”
...
One of the most important consequences of an ad hominem attack is that it often disguises a shift in the burden of proof.

Suppose someone argues:

> “You have been wrong before, so your current claim should be rejected.”
...
* More importantly, what evidence addresses the original claim?
* Has any argument been offered against the actual reasoning?
...
> “You have questioned the source. What evidence shows the claim itself is incorrect?”
...
* A witness has a documented history of fabrication.
* A researcher failed to disclose a significant conflict of interest.
* An expert lacks the qualifications being claimed.
* A public official's actions directly contradict factual claims about those actions.
...
1. **Do not defend every accusation.**
2. **Identify the unanswered claim.**
3. **Separate the person from the evidence.**
4. **Ask what evidence refutes the argument.**
5. **Restate the central issue.**

</div>

For example:

> “You have criticised my motives. What evidence shows that the policy will fail?”
