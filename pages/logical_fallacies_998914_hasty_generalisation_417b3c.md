...
child_basenames:
- logical_fallacies_998914_hasty_generalisation_417b3c_index
...
show_ads: true
description: Hasty generalisations draw big conclusions from too little evidence or from examples that are not representative.
hero_summary: Hasty generalisations draw big conclusions from too little evidence or from examples that are not representative.
layout: default
...
page_heading_title: How Much Evidence Is Enough?
source_count: 123
infographic_count: 3
planned_sections:
- Small samples
...
next_link:
  ...
  heading_title: Are You Being Pressured to Join?
header:
  og_image: /assets/images/logical_fallacies_998914_hasty_generalisation_417b3c-overview-social.jpg
  preview_image: /assets/images/logical_fallacies_998914_hasty_generalisation_417b3c-overview.webp
image: /assets/images/logical_fallacies_998914_hasty_generalisation_417b3c-overview-social.jpg
---
...
1. **How many cases are being used?** A few cases may suggest a lead, not a settled pattern.
2. **Where did they come from?** Evidence from one channel, place or social group may not travel well.
3. **Who is missing?** Non-responders, quiet users, unsuccessful cases and excluded groups may change the picture.
4. **Would the conclusion survive a broader sample?** If a wider, fairer sample might easily reverse the claim, the generalisation should be softened.
