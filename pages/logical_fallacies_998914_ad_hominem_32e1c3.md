...
- logical_fallacies_998914_ad_hominem_32e1c3_index
...
show_ads: true
description: Ad hominem arguments shift attention from the claim to the person, often making disagreement less rational.
hero_summary: Ad hominem arguments shift attention from the claim to the person, often making disagreement less rational.
layout: default
...
page_heading_title: When Personal Attacks Replace Reasons
source_count: 95
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: How Ads Make Weak Claims Persuasive
header:
  og_image: /assets/images/logical_fallacies_998914_ad_hominem_32e1c3-overview-social.jpg
  preview_image: /assets/images/logical_fallacies_998914_ad_hominem_32e1c3-overview.webp
image: /assets/images/logical_fallacies_998914_ad_hominem_32e1c3-overview-social.jpg
---
...
2. Person B points to a disliked trait, motive, past action or association of A.
3. Person B concludes that X is false, unserious or not worth answering.
...
* **[Relevant credibility]({{ 'credibility-840c81/' | relative_url }}) challenge:** “This witness has a documented history of falsifying evidence in similar cases, so their testimony needs corroboration.”
...
1. **Acknowledge only what is relevant.** “My background may be relevant to potential bias, so it is fair to ask for sources.”
2. **Return to the claim.** “The specific claim is that the policy reduced waiting times by 12%; here is the dataset.”
3. **Ask for a reasoned objection.** “Which part of the evidence or inference do you think is wrong?”
